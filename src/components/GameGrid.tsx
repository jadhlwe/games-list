import { Rocket, Dice1, Bomb, PlayCard, Target, ChessKing, Football, Waves, Diamond } from "lucide-react";
...
const games = [
  ...
  { title: "Cards", icon: PlayCard, gradient: "bg-gradient-to-br from-pink-500 to-rose-400" },
  { title: "Roulette", icon: Target, gradient: "bg-gradient-to-br from-indigo-500 to-purple-500" },
  { title: "Tower", icon: ChessKing, gradient: "bg-gradient-to-br from-cyan-500 to-blue-500" },
  { title: "Goal", icon: Football, gradient: "bg-gradient-to-br from-violet-600 to-indigo-600" },
