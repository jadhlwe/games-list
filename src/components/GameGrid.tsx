import { Rocket, Dice1, Bomb, PlayCircle, Target, ChessRook, Football, Waves, Diamond } from "lucide-react";
...
const games = [
  ...
  { title: "Tower", icon: ChessRook, gradient: "bg-gradient-to-br from-cyan-500 to-blue-500" },
